...
## Bugs
- I am aware that my previously viewed bar is rendering multiple Cities that have been searched. This is due to react rendering components multiple times for effeciency. There are fixes for this and I will implement it later
